...
// FIXME: We probably should reuse the JSON exporter to feed the data into the
// charts, instead of doing it on our own.
...
void HTMLReporter::ReportRuns(std::vector<Run> const &reports) {
  ...
  //   ComputeStats(reports, &report_data, &stddev_data);
