...
BenchmarkTimeDescription::BenchmarkTimeDescription()
...
void BenchmarkTimeDescription::SetUnitString(TimeUnit unit_multiplier) {
...
void BenchmarkTimeDescription::SetCpuUnitString(TimeUnit cpu_unit_multiplier) {
