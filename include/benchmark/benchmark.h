...
class Benchmark {
 ...
 private:
  // prepare() is called before this benchmark is run.
...
// Create and register a fixture benchmark with the specified 'name' whose fixture
// is created by creator
//
// RETURNS: A pointer to the registered benchmark.
internal::Benchmark* RegisterBenchmark(const char* name,
                                       internal::FixtureCreator *creator);
...
#define BENCHMARK_PRIVATE_REGISTER_F(TestName) \
  BENCHMARK_PRIVATE_DECLARE(TestName) =        \
      (::benchmark::RegisterBenchmark(#TestName, TestName::Create))
