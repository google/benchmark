...
SubMap& GetSubstitutions() {
  ...
  static SubMap map = {
      ...
      {"%csv_header",
       "name,base_name,id,family,repetitions,"
       "threads,iterations,real_time,cpu_time,time_unit,"
       "bytes_per_second,items_per_second,label,error_occurred,"
       "error_message"},
      {"%csv_ids", "[0-9]+,[0-9]+,[0-9]+,[0-9]+"},
      {"%csv_report", "[0-9]+,[0-9]+,[0-9]+,[0-9]+,[0-9]+," + safe_dec_re +
                          "," + safe_dec_re + ",ns,,,,,"},
      {"%csv_us_report",
       "[0-9]+," + safe_dec_re + "," + safe_dec_re + ",us,,,,,"},
      {"%csv_bytes_report", "[0-9]+,[0-9]+,[0-9]+,[0-9]+,[0-9]+," +
                                safe_dec_re + "," + safe_dec_re + ",ns," +
                                safe_dec_re + ",,,,"},
      {"%csv_items_report", "[0-9]+,[0-9]+,[0-9]+,[0-9]+,[0-9]+," +
                                safe_dec_re + "," + safe_dec_re + ",ns,," +
                                safe_dec_re + ",,,"},
      {"%csv_bytes_items_report", "[0-9]+,[0-9]+,[0-9]+,[0-9]+,[0-9]+," +
                                      safe_dec_re + "," + safe_dec_re + ",ns," +
                                      safe_dec_re + "," + safe_dec_re + ",,,"},
      {"%csv_label_report_begin", "[0-9]+,[0-9]+,[0-9]+,[0-9]+,[0-9]+," +
                                      safe_dec_re + "," + safe_dec_re +
                                      ",ns,,,"},
