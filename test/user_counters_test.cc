...
ADD_CASES(TC_JSONOut, {{"\"name\": \"BM_Counters_Simple\",$"},
                       ...
                       {"\"function_name\": \"BM_Counters_Simple\",$", MR_Next},
                       {"\"arguments\": \\[],$", MR_Next},
...
ADD_CASES(TC_JSONOut,
          {{"\"name\": \"BM_Counters_WithBytesAndItemsPSec\",$"},
           ...
           {"\"function_name\": \"BM_Counters_WithBytesAndItemsPSec\",$",
            MR_Next},
           {"\"arguments\": \\[],$", MR_Next},
           {"\"run_type\": \"iteration\",$", MR_Next},
           {"\"repetitions\": 1,$", MR_Next},
...
ADD_CASES(TC_JSONOut, {{"\"name\": \"BM_Counters_Rate\",$"},
                       ...
                       {"\"function_name\": \"BM_Counters_Rate\",$", MR_Next},
                       {"\"arguments\": \\[],$", MR_Next},
                       {"\"run_type\": \"iteration\",$", MR_Next},
                       {"\"repetitions\": 1,$", MR_Next},
                       {"\"repetition_index\": 0,$", MR_Next},
...
ADD_CASES(TC_JSONOut, {{"\"name\": \"BM_Invert\",$"},
                       ...
                       {"\"function_name\": \"BM_Invert\",$", MR_Next},
                       {"\"arguments\": \\[],$", MR_Next},
                       {"\"run_type\": \"iteration\",$", MR_Next},
                       {"\"repetitions\": 1,$", MR_Next},
                       {"\"repetition_index\": 0,$", MR_Next},
...
ADD_CASES(TC_JSONOut,
          {{"\"name\": \"BM_Counters_InvertedRate\",$"},
           ...
           {"\"function_name\": \"BM_Counters_InvertedRate\",$", MR_Next},
           {"\"arguments\": \\[],$", MR_Next},
           {"\"run_type\": \"iteration\",$", MR_Next},
           {"\"repetitions\": 1,$", MR_Next},
           {"\"repetition_index\": 0,$", MR_Next},
...
ADD_CASES(TC_JSONOut,
          {{"\"name\": \"BM_Counters_Threads/threads:%int\",$"},
           ...
           {"\"function_name\": \"BM_Counters_Threads\",$", MR_Next},
           {"\"arguments\": \\[],$", MR_Next},
           {"\"run_type\": \"iteration\",$", MR_Next},
           {"\"repetitions\": 1,$", MR_Next},
           {"\"repetition_index\": 0,$", MR_Next},
...
ADD_CASES(TC_JSONOut,
          {{"\"name\": \"BM_Counters_AvgThreads/threads:%int\",$"},
           ...
           {"\"function_name\": \"BM_Counters_AvgThreads\",$", MR_Next},
           {"\"arguments\": \\[],$", MR_Next},
           {"\"run_type\": \"iteration\",$", MR_Next},
           {"\"repetitions\": 1,$", MR_Next},
           {"\"repetition_index\": 0,$", MR_Next},
...
ADD_CASES(TC_JSONOut,
          {{"\"name\": \"BM_Counters_AvgThreadsRate/threads:%int\",$"},
           ...
           {"\"run_name\": \"BM_Counters_AvgThreadsRate/threads:%int\",$",
            MR_Next},
           {"\"function_name\": \"BM_Counters_AvgThreadsRate\",$", MR_Next},
           {"\"arguments\": \\[],$", MR_Next},
           {"\"run_type\": \"iteration\",$", MR_Next},
           {"\"repetitions\": 1,$", MR_Next},
           {"\"repetition_index\": 0,$", MR_Next},
...
ADD_CASES(TC_JSONOut,
          {{"\"name\": \"BM_Counters_IterationInvariant\",$"},
           ...
           {"\"function_name\": \"BM_Counters_IterationInvariant\",$", MR_Next},
           {"\"arguments\": \\[],$", MR_Next},
           {"\"run_type\": \"iteration\",$", MR_Next},
           {"\"repetitions\": 1,$", MR_Next},
           {"\"repetition_index\": 0,$", MR_Next},
...
ADD_CASES(TC_JSONOut,
          {{"\"name\": \"BM_Counters_kIsIterationInvariantRate\",$"},
           ...
           {"\"run_name\": \"BM_Counters_kIsIterationInvariantRate\",$",
            MR_Next},
           {"\"function_name\": \"BM_Counters_kIsIterationInvariantRate\",$",
            MR_Next},
           {"\"arguments\": \\[],$", MR_Next},
           {"\"run_type\": \"iteration\",$", MR_Next},
           {"\"repetitions\": 1,$", MR_Next},
...
ADD_CASES(TC_JSONOut,
          {{"\"name\": \"BM_Counters_AvgIterations\",$"},
           ...
           {"\"function_name\": \"BM_Counters_AvgIterations\",$", MR_Next},
           {"\"arguments\": \\[],$", MR_Next},
           {"\"run_type\": \"iteration\",$", MR_Next},
           {"\"repetitions\": 1,$", MR_Next},
           {"\"repetition_index\": 0,$", MR_Next},
...
ADD_CASES(TC_JSONOut,
          {{"\"name\": \"BM_Counters_kAvgIterationsRate\",$"},
           ...
           {"\"function_name\": \"BM_Counters_kAvgIterationsRate\",$", MR_Next},
           {"\"arguments\": \\[],$", MR_Next},
           {"\"run_type\": \"iteration\",$", MR_Next},
           {"\"repetitions\": 1,$", MR_Next},
           {"\"repetition_index\": 0,$", MR_Next},
